...
namespace Open_API_2._0_Sample
{
    public partial class Main : Form
    {
        ...
        */
        ...
        private string _apiHost = "live.ctraderapi.com";
        ...
        {
            var msgFactory = new OpenApiMessagesFactory();
            var msg = msgFactory.CreateStopOrderRequest(Convert.ToInt32(_accountID), _token, 1, ProtoOATradeSide.BUY, Convert.ToInt64(100000), 1.2, 1.5, 1.2);
            Transmit(msg);
        }
        ...
        {
            var msgFactory = new OpenApiMessagesFactory();
            var msg = msgFactory.CreateLimitOrderRequest(Convert.ToInt32(_accountID), _token, 1, ProtoOATradeSide.BUY, Convert.ToInt64(100000), 1.1, 1.5, 1.0);
            Transmit(msg);
        }
        ...
        {
            var msgFactory = new OpenApiMessagesFactory();
            var msg = msgFactory.CreateStopLimitOrderRequest(Convert.ToInt32(_accountID), _token, 1, ProtoOATradeSide.BUY, Convert.ToInt64(100000), 1.2, 5, 1.5, 1.2);
            Transmit(msg);
        }
        private void m_btnMarketRangeOrder_Click(object sender, EventArgs e)
        {
            var msgFactory = new OpenApiMessagesFactory();
            var msg = msgFactory.CreateMarketRangeOrderRequest(Convert.ToInt32(_accountID), _token, 1, ProtoOATradeSide.BUY, Convert.ToInt64(100000), 1.2, 5);
            Transmit(msg);
        }
